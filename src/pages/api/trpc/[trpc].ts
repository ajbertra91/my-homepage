  ...
  .query('work-history', {
    ...
    resolve() {
      ...
      return {
        ...
        TAB_TWO: 'Education',
        empowerDesc: [
          'Leverages experience of micro-services and web-components to deliver new light weight components',
          'Optimizes accessibility of existing customer facing components and apps.',
          'Maintains the high performance of the Prudential apps purchased by Empower, with a similar role as described below.'
        ],
        prudentialDesc: [
          'Improved application Ease-of-Doing-Business score from 6.8 to 8.9 (out of 10)',
          'Modernized applications, adding responsive micro-serviced frontend components, increasing performance from 8s to less than 2s',
